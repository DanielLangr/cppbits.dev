...
:description: The goal of a {cpp} implementation is to provide, on a particular computer system, the observable behavior of a program defined for its source code by the {cpp} standard.

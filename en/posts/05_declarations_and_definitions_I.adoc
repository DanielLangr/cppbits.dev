...
[.normal]
//link:../../cs/posts/05_deklarace_a_definice.html[Česká verze] image:https://www.countryflags.io/cz/shiny/24.png[Česká verze, link="../../cs/posts/05_deklarace_a_definice.html"] +
...
.Summary
****
- A *function declaration* instructs a compiler to *generate machine code for calls of this function*.

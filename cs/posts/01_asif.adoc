...
[.normal]
link:../index.html[Úvodní stránka]
...
Operační kód (_opcode_) té druhé je totiž `b8 00 00 00 00`, zatímco té první `32 c0`, a tedy podstatně kratší. To v praxi šetří množství přenesených dat mezi oprační pamětí a procesorem a zvyšuje efektivitu práce s instrukční cache pamětí.
****
